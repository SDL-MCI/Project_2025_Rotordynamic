...
Douter  = 51e-3*2 # float(input("Outer diameter of beam [m]: "))
...
disc1_diam = 0.14810870264652345*2    # float(input("Disc 1 diameter [m]: "))   # [m] diameter of rigid disc
disc1_thick = 0.022410536230310623  # float(input("Disc 1 thickness [m]: "))   # [m] axial thickness
disc1_density = 7833.4 # float(input("Disc 1 density [kg/m^3]: "))   # [kg/m³] (same as beam material)

disc2_pos = 16 # float(input("Disc 2 position [m]: "))
disc2_diam = 0.14810870264652345*2      # float(input("Disc 2 diameter [m]: "))
disc2_thick = 0.022410536230310623  # float(input("Disc 2 thickness [m]: "))
...
#Test 1 normal : 52 prof et 51 for us 

#Test 2 : without 1/12 -> +0.01Hz

#Test 3 : we're at 51Hz
 # m = 12.098  
 #  J = 35775e-6 
 #  I = 66346e-6
...
# # Radius rr and thickness

# In[25]:


import math
rr=2*math.sqrt(66346e-6/12.098)
rr
